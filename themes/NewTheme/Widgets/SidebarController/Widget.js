define(['dojo/_base/declare', 'jimu/PoolControllerMixin', 'dojo/on', 'dojo/query', 'dojo/dom-class', 'jimu/BaseWidget'],
  function(declare, PoolControllerMixin, on, query, domClass, BaseWidget) {
    return declare([BaseWidget, PoolControllerMixin], {

      baseClass: 'jimu-widget-sidebar-controller jimu-main-background', //a parte de el sidebar tambien cogera los colores del selector de estilos
      allConfigs: [],
      openedWidgetId: '',
      activeIconNode: null,
